    ...
    public const PHONE_DATA = [
        'US' => [
            ...
            'mobile_begin_with'    => [
                    ...
                    '252', '253', '254', '256', '260', '262', '267', '269', '270', '272', '274', '276', '278', '279', '281',
                    '283', '301', '302', '303', '304', '305', '307', '308', '309', '310', '312', '313', '314', '315', '316',
                    '317', '318', '319', '320', '321', '323', '325', '326', '327', '329', '330', '331', '332', '334', '336',
                    '337', '339', '340', '341', '346', '347', '350', '351', '352', '353', '360', '361', '363', '364', '369',
                    '380', '385', '386', '401', '402', '404', '405', '406', '407', '408', '409', '410', '412', '413', '414',
                    '415', '417', '419', '423', '424', '425', '430', '432', '434', '435', '440', '441', '442', '443', '445',
                    ...
                    '609', '610', '612', '614', '615', '616', '617', '618', '619', '620', '623', '626', '627', '628', '629',
                    '630', '631', '636', '640', '641', '645', '646', '650', '651', '656', '657', '659', '660', '661', '662',
                    '667', '669', '678', '679', '680', '681', '682', '686', '689', '701', '702', '703', '704', '706', '707',
                    '708', '712', '713', '714', '715', '716', '717', '718', '719', '720', '724', '725', '726', '727', '728',
                    '730', '731', '732', '734', '737', '740', '743', '747', '752', '754', '757', '760', '762', '763', '764',
                    '765', '769', '770', '771', '772', '773', '774', '775', '779', '781', '785', '786', '787', '800', '801',
                    '802', '803', '804', '805', '806', '808', '810', '812', '813', '814', '815', '816', '817', '818', '820',
                    '821', '826', '828', '830', '831', '832', '833', '835', '838', '839', '840', '843', '844', '845', '847',
                    '848', '850', '854', '855', '856', '857', '858', '859', '860', '862', '863', '864', '865', '866', '870',
                    '872', '877', '878', '888', '901', '903', '904', '906', '907', '908', '909', '910', '912', '913', '914',
                    '915', '916', '917', '918', '919', '920', '924', '925', '927', '928', '929', '930', '931', '934', '935',
                    '936', '937', '938', '939', '940', '941', '943', '945', '947', '948', '949', '951', '952', '954', '956',
                    '957', '959', '970', '971', '972', '973', '975', '978', '979', '980', '983', '984', '985', '986', '989',
                ],
        ...
        'AS' => [
            ...
            'mobile_begin_with'    => ['684258', '684733'],
            'phone_number_lengths' => [10],
        ],
        'AG' => [
            'alpha2'               => 'AG',
        ...
        'BI' => [
            ...
            'mobile_begin_with'    => ['29', '61', '68', '69', '71', '72', '75', '76', '77', '79'],
            'phone_number_lengths' => [8],
        ],
        'BE' => [
            'alpha2'               => 'BE',
        ...
        'CA' => [
            ...
            'mobile_begin_with'    => [
                    ...
                    '782', '807', '819', '825', '867', '873', '902', '905', '942',
                ],
            'phone_number_lengths' => [10],
        ],
        'CH' => [
        ...
        'DK' => [
            ...
            'mobile_begin_with'    => [
                    '2', '30', '31', '342', '344', '345', '346', '347', '348', '349', '356', '357', '359', '362', '365',
                    '366', '389', '398', '40', '41', '42', '431', '441', '462', '466', '468', '472', '474', '476', '478',
                    '485', '486', '488', '489', '493', '494', '495', '496', '498', '499', '50', '51', '52', '53', '542',
                    '543', '545', '551', '552', '556', '571', '572', '573', '574', '577', '579', '584', '586', '587', '589',
                    '597', '598', '60', '61', '627', '629', '641', '649', '658', '662', '663', '664', '665', '667', '692',
                    '693', '694', '697', '71', '771', '772', '782', '783', '785', '786', '788', '789', '81', '826', '827',
                    '829', '91', '92', '93',
                ],
            'phone_number_lengths' => [8],
        ],
        ...
        'EG' => [
            ...
            'country_code'         => '20',
            'country_name'         => 'Egypt',
            'mobile_begin_with'    => ['1', 10, 11, 12, 15],
        ...
        'RU' => [
            ...
            'mobile_begin_with'    => ['495', '498', '499', '835', '9'],
            'phone_number_lengths' => [10],
        ],
        'RW' => [
            'alpha2'               => 'RW',
